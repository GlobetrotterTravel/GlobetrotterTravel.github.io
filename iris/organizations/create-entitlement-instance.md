---
layout: default
title: Create an entitlement instance
parent: Organizations
grand_parent: Globetrotter Iris
nav_order: 50
permalink: /iris/organizations/create-entitlement-instance/
---

# Create an entitlement instance
{: .no_toc }

Entitlement instances are assigned to organizations to show which services and benefits each organization has access to.

Entitlements can automatically configure downstream systems to apply correct service levels that are centrally controlled through Iris.
...
Click `Save`. The entitlement instance is created.