...
- [GetAllEntitlementDefinitions](GetAllEntitlementDefinitions) - Get all entitlement definitions
...
- [RenewEntitlementInstance](RenewEntitlementInstance) - Extend entitlement expiry
